//Define Selectors
const INPUT_HEIGHT = document.getElementsByClassName('input-height')[0];
const INPUT_WIDTH = document.getElementsByClassName('input-width')[0];
...
const PIXEL_CANVAS = document.getElementsByClassName('pixel-canvas')[0];
